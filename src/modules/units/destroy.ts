...
async function destroyUnit({ auth, args, services }: Props<Args, Services, t.PlatformTokenAuth>): Promise<Response> {
  ...
  if (args.workspaceId !== workspaceId) {
    throw errors.badRequest({
      ...
      key: 'exo.err.units.destroy.workspace-mismatch'
    })
  }
  ...
  if (!workspace) {
    throw errors.notFound({
      ...
      key: 'exo.err.units.destroy.no-workspace'
    })
  }
  ...
  if (!platform) {
    throw errors.notFound({
      ...
      key: 'exo.err.units.destroy.no-platform'
    })
  }
  ...
  if (!unit) {
    throw errors.notFound({
      ...
      key: 'exo.err.units.destroy.no-unit'
    })
  }
  ...
  if (builderResponse.error) {
    throw errors.unknown({
      ...
      key: 'exo.err.units.destroy.bad-builder'
    })
  }
